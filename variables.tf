...
variable "ebs_io_credit_balance" {
  type        = string
  description = "EBS I/O burst credits for smaller EBS optimized instance types (static|off)."
  default     = "static"
}
...
variable "ebs_throughput_credit_balance" {
  type        = string
  description = "EBS throughput burst credits for smaller EBS optimized instance types (static|off)."
  default     = "static"
}
